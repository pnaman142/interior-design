      ...
      <div className="container">
        ...
        <div className="lg:py-20">
          ...
          <div className="grid py-8 gap-20 lg:grid-cols-3 ">
            ...
            >
              <div className="p-4 text-center bg-gray-100 dark:bg-accent aspect-square -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3">
                <Image
            ...
            <motion.div
              ...
              className="border-2 border-primary"
            >
              <div className="p-4 text-center bg-gray-100 aspect-square dark:bg-accent -m-0.5 transition hover:-translate-y-3 hover:-translate-x-3">
                <Image
