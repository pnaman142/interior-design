    ...
    <div className="pt-12">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mx-auto mt-10 grid lg:grid-cols-3 grid-cols-1 gap-x-8 lg:max-m-none lg:mx-0 sm:py-16 sm:mt-16 py-10 border-b border-gray-200 border-t gap-y-16"
        >
          {posts.map((post) => (
            <article
              key={post.id}
