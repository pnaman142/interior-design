  ...
  return (
    <div className="container py-12 xl:py-24 h-[auto] text-center lg:py-0 lg:text-left lg:flex lg:justify-between">
      ...
      <div className="lg:w-1/2 xl:py-14 lg:py-8">
        ...
        px-8 py-3 text-white rounded-full shadow-lg 
        hover:bg-gray-800 hover:ring-2 hover:ring-gray-950 
        ring-offset-2"
          >
      ...
      <div className="w-1/2">
        <Image
          ...
          height={500}
          alt=""
          className="absolute xl:h-[448px] xl:w-[650px] lg:h-[344px] lg:w-[500px] hidden lg:block"
        />
      </div>
    </div>
  );
